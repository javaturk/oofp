...
public class Book implements Comparable {
	...
	public Book() {
		...
		this.authorFName = "No authpr first name specified!";
		this.authorLName = "No author last name specified!";
		this.pages = 0;
		this.sciFi = false;
	}

	public Book(String title, String authorFName, String authorLName, int pages, boolean sciFi) {
		this.title = title;
...
//		System.out.println("in getAuthorLName()");
		return authorLName;
	}
